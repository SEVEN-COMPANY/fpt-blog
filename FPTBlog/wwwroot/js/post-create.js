...
eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nvar axios_1 = __webpack_require__(/*! ../package/axios */ \"./src/package/axios/index.ts\");\r\nvar routes_1 = __webpack_require__(/*! ../package/axios/routes */ \"./src/package/axios/routes.ts\");\r\nvar createPostForm = document.getElementById('createNewPost');\r\ncreatePostForm === null || createPostForm === void 0 ? void 0 : createPostForm.addEventListener('click', function (event) {\r\n    axios_1.http.post(routes_1.routers.post.create).then(function (res) {\r\n        window.location.reload();\r\n    });\r\n});\r\nvar deletePost = document.getElementsByClassName('delete-post');\r\nvar _loop_1 = function (index) {\r\n    var element = deletePost[index];\r\n    element.addEventListener('click', function () {\r\n        var isSend = confirm('Are you sure to delete this draft?');\r\n        if (isSend) {\r\n            var postId = element.getAttribute('data-postId');\r\n            axios_1.http.put(routes_1.routers.post.deletePost, { PostId: postId }).then(function (res) {\r\n                setTimeout(function () {\r\n                    window.location.reload();\r\n                }, 1000);\r\n            });\r\n        }\r\n    });\r\n};\r\nfor (var index = 0; index < deletePost.length; index++) {\r\n    _loop_1(index);\r\n}\r\n\n\n//# sourceURL=webpack://mono-webpack/./src/post/create.ts?");
